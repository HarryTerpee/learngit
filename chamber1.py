...
setbs=mc.setBlocks
def east(x,y,z):
    setbs(x,y-2,z-5,x+20,y-1,z+5,57)
    setbs(x,y-1,z-5,x+20,y+5,z-5,57)
    setbs(x,y-1,z+5,x+20,y+5,z+5,57)
    setbs(x,y+5,z-5,x+20,y+5,z+5,57)
    setbs(x,y+2,z-5,x+20,y+2,z-5,138)
    setbs(x,y+2,z+5,x+20,y+2,z+5,138)
...
def south(x,y,z):
    setbs(x-5,y-2,z,x+5,y-1,z+20,57)
    setbs(x-5,y-1,z,x-5,y+5,z+20,57)
    setbs(x+5,y-1,z,x+5,y+5,z+20,57)
    setbs(x-5,y+5,z,x+5,y+5,z+20,57)
    setbs(x+5,y+2,z,x+5,y+2,z+20,138)
    setbs(x-5,y+2,z,x-5,y+2,z+20,138)
